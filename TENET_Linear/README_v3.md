...
## [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **TENET_Linear** [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/d3/ia)
...
linear quantile lasso algorithm. The 110 covariates include log returns of 99 firms (except for
firm k) 7 macro state variables and 4 firm k’s characteristics.'
...
Output: - lambda_l[i] : scalar estimated penalization parameter - beta_l[i, ] : p estimated
coefficients - CoVaR_l[i] : scalar estimated CoVaR
```
